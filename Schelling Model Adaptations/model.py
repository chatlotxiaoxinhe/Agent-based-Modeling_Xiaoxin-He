...
class SchellingModel(Model):
    ...
    ## Add decay_threshold and decay_amount into parameters
    def __init__(self, width = 30, height = 30, density = 0.7, desired_share_alike = 0.5, group_one_share = 0.7, radius = 1, decay_threshold=5, decay_amount=0.05, seed = None):
        ...
        self.happy = 0
        self.tolerance = desired_share_alike
        ## Initialize decay_threshold and decay_amount
        ...
        self.datacollector = DataCollector(
            model_reporters = {
                ...
                if len(m.agents) > 0
                 ...
                 # individual tolerance decay
                "avg_tolerance": lambda m: sum([a.current_tolerance for a in m.agents]) / len(m.agents)
                if len(m.agents) > 0
                else 0
            }
        )
